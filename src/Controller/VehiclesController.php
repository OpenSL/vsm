...
class VehiclesController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Customers', 'VehicleCategories', 'VehicleSubCategories']
        ];
    ...
    public function add()
    {
        ...
        $customers = $this->Vehicles->Customers->find('list', ['limit' => 200]);
        $vehicleCategories = $this->Vehicles->VehicleCategories->find('list', ['limit' => 200]);
        $vehicleSubCategories = $this->Vehicles->VehicleSubCategories->find('list', ['limit' => 200]);
        $this->set(compact('vehicle', 'customers', 'vehicleCategories', 'vehicleSubCategories'));
        $this->set('_serialize', ['vehicle']);
    }
